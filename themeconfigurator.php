...
class ThemeConfigurator extends Module
{
	...
	protected function installFixture($hook, $id_image, $id_shop, $id_lang)
	{
		...
		$result &= Db::getInstance()->Execute('
			INSERT INTO `'._DB_PREFIX_.'themeconfigurator` (
					`id_shop`, `id_lang`, `item_order`, `title`, `title_use`, `hook`, `url`, `target`, `image`, `image_w`, `image_h`, `html`, `active`,`columns`
			) VALUES (
				\''.(int)$id_shop.'\',
				\''.(int)$id_lang.'\',
				\''.(int)$id_image.'\',
	...
	protected function addItem()
	{
		...
		if (!Db::getInstance()->Execute('
			INSERT INTO `'._DB_PREFIX_.'themeconfigurator` (
					`id_shop`, `id_lang`, `item_order`, `title`, `title_use`, `hook`, `url`, `target`, `image`, `image_w`, `image_h`, `html`,`columns`, `active`
			) VALUES (
					...
					\''.pSQL(Tools::getValue('item_columns')).'\',
					1)'
		))
		{
