					...
					<li id="item-{$hItem.id_item|escape:'htmlall':'UTF-8'}" class="item well">
						<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
							...
							<div class="item-container clearfix">
								...
								<div class="columns item-field form-group">
									<label class="control-label col-lg-3">{l s='Columns' mod='themeconfigurator'}</label>
									<div class="col-lg-7">
										<label class="radio-inline">
											<input type="radio" name="item_columns" id="item_columns1" value="1"{if $hItem.columns == 1} checked{/if}> 1
										</label>
										<label class="radio-inline">
											<input type="radio" name="item_columns" id="item_columns2" value="2"{if $hItem.columns == 2} checked{/if}> 2
										</label>
										<label class="radio-inline">
											<input type="radio" name="item_columns" id="item_columns3" value="3"{if $hItem.columns == 3} checked{/if}> 3
										</label>
									</div>
								</div>
